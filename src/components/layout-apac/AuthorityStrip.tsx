...
const stats = [
    { label: 'APAC Markets Reached', value: 18, suffix: '+' },
    { label: 'Innovation Hubs', value: 4, suffix: '' },
    { label: 'Hyper-Scale Systems', value: 300, suffix: '+' },
    { label: 'Tech Operations', value: 50, suffix: '+' },
];
