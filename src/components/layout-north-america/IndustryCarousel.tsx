...
const industries = [
    { title: "SaaS & High-Growth Startups", category: "Commercial", solution: "Scalable microservices architecture & cloud optimization.", image: "/industries/saas.jpg", link: "/industries/saas" },
    { title: "Fintech & Banking", category: "High-Value", solution: "High-frequency trading infrastructure & secure payments.", image: "/industries/banking.jpg", link: "/industries/fintech" },
    { title: "Healthcare & Life Sciences", category: "Sovereign", solution: "Telemedicine platforms & HIPAA compliant patient data.", image: "/industries/healthcare.jpg", link: "/industries/healthcare" },
    { title: "Logistics", category: "Industrial", solution: "End-to-end supply chain visibility & coast-to-coast fleet tracking.", image: "/industries/logistics.jpg", link: "/industries/supplychain" },
    { title: "Retail & E-commerce", category: "Commercial", solution: "Omnichannel customer analytics & massive inventory AI.", image: "/industries/retail.jpg", link: "/industries/retail" },
    { title: "Energy & Utilities", category: "Industrial", solution: "Grid modernization & renewable asset telemetry.", image: "/industries/energy.jpg", link: "/industries/energy" },
    { title: "Real Estate & PropTech", category: "Commercial", solution: "Smart building management & asset valuation models.", image: "/industries/realestate.jpg", link: "/industries/realestate" },
    { title: "Telecom", category: "Commercial", solution: "5G network slicing & automated infrastructure deployment.", image: "/industries/telecom.jpg", link: "/industries/telecom" }
];
