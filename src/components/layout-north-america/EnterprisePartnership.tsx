                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
                    ...
                    >
                        <h2 className="text-xs font-bold text-[#0d938c] uppercase tracking-[0.3em] mb-6">
                            North American Strategic Partnerships
                        </h2>
                        <h3 className="text-3xl md:text-5xl font-bold text-slate-900 tracking-tight leading-[1.1] mb-6">
                            Co-innovating with <br />
                            <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#0d938c] to-[#0a706b]">Silicon Valley Caliber Engineering</span>
                        </h3>
                        <p className="text-slate-500 text-lg leading-relaxed mb-8 max-w-lg">
                            We partner with enterprise leaders across the US and Canada to build secure, wildly scalable solutions. Operate in sync with our nearshore-equivalent delivery model.
                        </p>

                        <div className="space-y-4 mb-10">
                            {[
                                "100% US Timezone Alignment",
                                "SOC2 & HIPAA Compliant Architecture",
                                "Dedicated Coastal Delivery Pods",
                            ].map((item, i) => (
                    ...
                    >
                        <div className="absolute inset-0 bg-slate-200">
                            <Image
                                src="/team.jpg"
                                alt="North American Tech Delivery Team"
                                fill
