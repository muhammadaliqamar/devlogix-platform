...
export default function CTASection({
    title = "Accelerate Your North American Operations",
    subtitle = "Deploy secure, scalable enterprise software from coast to coast. Let's build something intelligent together."
}: CTASectionProps) {
    return (
            ...
            <div className="w-full max-w-[1920px] mx-auto px-6 md:px-12 xl:px-20">
                <div className="bg-gradient-to-br from-[#0B1221] to-slate-900 rounded-3xl p-10 md:p-16 text-center text-white shadow-2xl relative overflow-hidden">
                    ...
                    <div className="flex flex-col items-center gap-6 relative z-10">
                        ...
                        <a
                            href="mailto:north-america@devlogix.com"
                        ...
                        >
                            Prefer email? reach us at north-america@devlogix.com
                        </a>
                    </div>
                </div>
            </div>
