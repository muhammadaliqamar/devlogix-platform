...
const stats = [
    { label: 'MEA Countries Served', value: 15, suffix: '+' },
    { label: 'Regional Tech Hubs', value: 3, suffix: '' },
    { label: 'Enterprise Systems Deployed', value: 150, suffix: '+' },
    { label: 'Local Partners', value: 40, suffix: '+' },
];

// 1. THE COUNTER COMPONENT (Handles the math & animation)
    ...
    useEffect(() => {
        if (isInView) {
            animate(motionValue, value, {
                duration: 2.5, // Slow, deliberate duration for "Scale"
                ease: [0.4, 0, 0.2, 1], // Institutional Bezier
            });
        }
                                ...
                                >
                                    <div className="flex items-baseline gap-1">
                                        <span className="text-4xl md:text-6xl font-bold text-[#0d938c] tracking-tighter">
                                            {/* 2. REPLACED STATIC TEXT WITH COUNTER COMPONENT */}
