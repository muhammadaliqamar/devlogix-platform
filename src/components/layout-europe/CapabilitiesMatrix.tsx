...
const capabilities = [
    ...
    { title: "IT Staff Augmentation", description: "Scale your internal engineering capacity instantly with our vetted top-tier European developers.", image: "/services/staff.jpg" },
    ...
    { title: "FinTech & Open Banking", description: "Implement secure, PSD2-compliant platforms for financial transactions and neo-banking.", image: "/services/blockchain.jpg" },
    { title: "Cloud & DevOps", description: "Deploy scalable infrastructure that guarantees EU data residency and high availability.", image: "/services/cloud.jpg" },
    ...
    { title: "Cybersecurity & Compliance", description: "Protect your infrastructure and data assets with zero-trust architectures and strict GDPR compliance.", image: "/services/cyber.jpg" },
    ...
    { title: "Strategic Tech Advisory", description: "Guide your long-term technology roadmap with expert advice on architecture and cross-border expansion.", image: "/services/advisory.jpeg" },
                    ...
                    <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
                        <h3 className="text-3xl md:text-5xl font-bold text-slate-900 tracking-tight leading-tight max-w-2xl">
                            ...
                            <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#0d938c] to-[#0a706b]">
                                Digital Excellence in the EU.
                            </span>
                        </h3>
                        <p className="text-slate-500 max-w-md text-sm leading-relaxed">
                            From enterprise platforms to GDPR-compliant data systems, we architect solutions that drive operational excellence across Europe and the UK.
                        </p>
                    </div>
                </div>
