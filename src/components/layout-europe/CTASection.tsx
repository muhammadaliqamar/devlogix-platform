...
export default function CTASection({
    title = "Accelerate Your European Operations",
    subtitle = "Deploy fully compliant, scalable enterprise software across the UK and Europe. Let's build something intelligent together."
}: CTASectionProps) {
    return (
            ...
            <div className="max-w-6xl mx-auto px-6">
                <div className="bg-gradient-to-br from-[#0B1221] to-slate-900 rounded-3xl p-10 md:p-16 text-center text-white shadow-2xl relative overflow-hidden">
                    ...
                    <div className="flex flex-col items-center gap-6 relative z-10">
                        ...
                        <a
                            href="mailto:europe@devlogix.com"
                        ...
                        >
                            Prefer email? reach us at europe@devlogix.com
                        </a>
                    </div>
                </div>
            </div>
