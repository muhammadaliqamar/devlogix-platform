                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
                    ...
                    >
                        ...
                        <h3 className="text-3xl md:text-5xl font-bold text-slate-900 tracking-tight leading-[1.1] mb-6">
                            ...
                            <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#0d938c] to-[#0a706b]">Top 1% Engineering</span>
                        </h3>
                        <p className="text-slate-500 text-lg leading-relaxed mb-8 max-w-lg">
                            We partner with enterprise leaders across the UK and Europe to build secure, scalable solutions. Scale your digital operations with our dedicated local delivery teams.
                        </p>

                        <div className="space-y-4 mb-10">
                            {[
                                "100% GDPR-Compliant Architecture",
                                "Local EU & UK Delivery Teams",
                                "Dedicated FinTech Innovation Labs",
                            ].map((item, i) => (
                    ...
                    >
                        <div className="absolute inset-0 bg-slate-200">
                            <Image
                                src="/team.jpg"
                                alt="European Tech Delivery Team"
                                fill
