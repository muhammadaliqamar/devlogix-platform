...
export default function CTASection({
    title = "مستعد لرسم مستقبلك؟",
    subtitle = "لنبني شيئاً ذكياً معاً."
}: CTASectionProps) {
    return (
            ...
            <div className="max-w-6xl mx-auto px-6">
                <div className="bg-gradient-to-br from-[#0B1221] to-slate-900 rounded-3xl p-10 md:p-16 text-center text-white shadow-2xl relative overflow-hidden">
                    ...
                    <div className="flex flex-col items-center gap-6 relative z-10">
                        ...
                        >
                            تواصل معنا
                            <ArrowRight className="w-5 h-5 transition-transform duration-300 transform rtl:rotate-180 group-hover:translate-x-1 rtl:group-hover:-translate-x-1" />
                        </Link>
                        ...
                        >
                            تفضل البريد الإلكتروني؟ تواصل معنا على strategic@devlogix.com.pk
                        </a>
